...
public class CustomerController {
    ...
    public ResponseEntity<ResponseDto> postCustomer(
        ...
        ResponseEntity<ResponseDto> response = customerService.postCustmoer(requestDto);
        return response;
    }
    ...
    public ResponseEntity<ResponseDto> patchCustomer(
        ...
        ResponseEntity<ResponseDto> response = customerService.pathCustomer(requestBody, customerNumber, userId);
        return response; 
    }
    ...
    public ResponseEntity<ResponseDto> postCareRecord(
        ...
        /*
        contents만 넣었을 때 -> su
        다 넣었을 떄 -> su -> tool에서 count 감소
        개수 초과 -> ti
        null 허용중 하나만 안넣으면 -> vf
         */
    }
